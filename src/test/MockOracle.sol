...
contract MockOracle is ChainlinkRequestInterface, LinkTokenReceiver {
     ...
     * Emits OracleRequest event for the Chainlink node to delete.
    ...
    /**
     * @notice Called by the Chainlink node to full requests
     ...
     * send for the request back to the requester's address.
