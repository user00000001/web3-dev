...
import { APIConsumer, MockLinkToken, MockOracle } from "../../typechain-types"
...
!developmentChains.includes(network.name)
    ...
    : describe("APIConsumer Unit Tests", async function () {
          ...
          beforeEach(async () => {
              const deployment = await deployments.fixture(["mocks", "api"])
              linkToken = await ethers.getContract("MockLinkToken")
